...
<details>
  ...
  <ul>
    <li><b>Texsa:</b> E-commerce UI/UX cloning.</li>
    <li><b>Online Bookstore:</b> Full-stack college project using HTML, CSS, JS.</li>
  </ul>
</details>
...
<details>
  ...
  <ul>
    <li>Homemade Flipper Zero using microcontroller modules.</li>
    <li>Remote control switch & keypad phone using ESP32/STM32.</li>
  </ul>
</details>
